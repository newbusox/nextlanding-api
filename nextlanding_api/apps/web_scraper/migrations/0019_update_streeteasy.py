...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
      ...
      orm['dynamic_scraper.scraperelem'].objects.filter(pk=39).update(
        proc_ctxt="'func':'nextlanding_api.apps.web_scraper.scrapy.processors.composite_func','funcs':('nextlanding_api.apps"
                  ".web_scraper.scrapy.processors.replace','nextlanding_api.apps.web_scraper.scrapy.processors"
                  ".split_reverse','nextlanding_api.apps.web_scraper.scrapy.processors.pre_string','nextlanding_api.apps.web_scraper.scrapy.processors.post_string'),'replace':{'linkToEmail(':'',\"'\":'',')':'','-':',','SE.':''},'pre_string':'fromCharCode(','post_string':')','split_reverse':','"
      )
