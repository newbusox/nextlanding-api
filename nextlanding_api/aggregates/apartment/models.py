...
from nextlanding_api.aggregates.apartment.managers import ApartmentManager
from nextlanding_api.aggregates.apartment.signals import adopted_listing, became_unavailable, created_from_listing
