import re
import logging
from nextlanding_api.libs.text_utils.formatting.text_formatter import unescape, despacify, decodeJs
...
def get_contact_email_address(contact_email_address_str):
  ...
  try:
    ...
    logger.warn(u"Error parsing email: {0}".format(contact_email_address_str), exc_info=1)
