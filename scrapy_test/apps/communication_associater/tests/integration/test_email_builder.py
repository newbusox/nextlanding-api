...
from scrapy_test.apps.communication_associater.tests import email_test_data


@pytest.mark.django_db_with_migrations
@patch('scrapy_test.apps.communication_associater.availability.email.services.availability_email_builder'
